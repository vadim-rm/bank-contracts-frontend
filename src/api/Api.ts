...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  accounts = {
     ...
     * @request PUT:/accounts/{accountId}/complete
     * @secure
     */
    completeUpdate: (accountId: number, request: HandlerCompleteAccountRequest, params: RequestParams = {}) =>
      this.request<void, HandlerErrorResponse>({
        path: `/accounts/${accountId}/complete`,
        method: "PUT",
        body: request,
        secure: true,
        type: ContentType.Json,
